 ...
 */
public class MOEARunner5_GrammarLengthAndNumLeaves {

    public static void main(String[] args) throws IOException {

        FileUtil util = new FileUtil();
        util.writeText("MOEARunner5_GrammarLengthAndNumLeaves", "info.txt");
        ...
        metrics.write("Name,grammar,generation,grammar_length,num_leaves\n");
        metrics.flush();
        int steps = 20000;
