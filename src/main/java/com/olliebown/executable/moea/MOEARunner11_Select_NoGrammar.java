 ...
 */
public class MOEARunner11_Select_NoGrammar {

    public static void main(String[] args) throws IOException {

        FileUtil util = new FileUtil();
        util.writeText("MOEARunner11_Select_NoGrammar", "info.txt");

        DeciderMOEAProblemNonGrammar theProblem = new DeciderMOEAProblemNonGrammar(5, "data/Training_short") {
